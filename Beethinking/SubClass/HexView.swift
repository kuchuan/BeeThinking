...
//        hexButton.frame = CGRect(x: 0, y: 0, width: 140, height: 140)
//
//        //ボタンの場所
//        hexButton.layer.position = CGPoint(x: 0, y: 0)
//
//        //ボタンの背景書
//        hexButton.backgroundColor = UIColor.clear
//
//        //ボタンの角丸
//        hexButton.layer.cornerRadius = 0
//
//        //ボタンの枠線定義
